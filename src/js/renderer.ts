...
ipcRenderer.on('currentPlaybackReceived', (_event, message) => setPlayer(message));
ipcRenderer.on('loading', () => setLoader());
ipcRenderer.on('noContent', () => setNoContent());
ipcRenderer.on('playlistsReceived', (_event, playlists) => openPlaylistsContainer(playlists));
